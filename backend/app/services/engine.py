...
# Власна стеля дози для потужної сировини (частка від основної).
#
# Базова формула дози описує, наскільки інгредієнт ВЛУЧАЄ в бажаний профіль, і
# нічого не знає про його силу. Через це хрін, що на 50% б'є в «зігріваючий»,
# отримував дозу 0.5 — тобто пів кілограма хрону на кілограм коріандру, що вже
# не напій. Тут задаємо, скільки такої сировини реально можна класти.
#
# ЦІ ЗНАЧЕННЯ — ПЕРШЕ НАБЛИЖЕННЯ і потребують звірки з практикою: вони
# впливають на кожен рецепт, де така сировина трапляється. Сировина, якої тут
# немає, дозується як раніше (лише за влучністю та ярусом).
POTENCY_CAP: Dict[str, float] = {
    # пекучі та сірчані — рахунок на грами
    "хрін": 0.05,
    "часник": 0.03,
    "червоний гострий перець": 0.03,
    "гірчиця": 0.05,
    "асафетида": 0.02,
    ...
    "дубова кора": 0.08,
    "звіробій": 0.12,
    # дуже інтенсивні прянощі
    "гвоздика": 0.08,
    "мускатний горіх": 0.06,
    "мускатний цвіт (мацис)": 0.06,
    "шафран": 0.02,
    "кориця цейлонська": 0.12,
    "кассія (китайська кориця)": 0.10,
    "бадьян": 0.12,
    "аніс": 0.15,
    "лавровий лист": 0.08,
    "чорний перець": 0.08,
    "духмяний перець": 0.08,
    "сичуанський перець": 0.06,
    "перець мелегета": 0.06,
    "сенегальський перець": 0.06,
    "кубеба": 0.08,
    "чорний кардамон": 0.06,
    "кардамон": 0.10,
    "імбир": 0.15,
    "куркума": 0.10,
    "калган (альпінія)": 0.10,
    "ваніль": 0.08,
    "лаванда": 0.10,
    "розмарин": 0.12,
    "чебрець (тим'ян)": 0.15,
...
def _dose(
    ...
    а для потужної сировини діє ще й власна стеля (див. POTENCY_CAP).
    """
    if material_id <= 0:
    ...
    potency = POTENCY_CAP.get(_resolve_name(db, material_id))
